	(function($) {
	    ...
	    */
	    $(document).on('click', '.save_text', function(event) {
	        ...
	        final.push('<p><h2>Type:text</h2><label>' + lbl + '</label><input type="text"' + req + 'name="' + name + '" placeholder="' + placeholder + '" class="' + cls + '"><a href="#" class="remove">remove</a></p>');
	    ...
	    $(document).on('click', '.save_date', function(event) {
	        ...
	        var cls = $(".class").val();
	        var placeholder = $(".placeholder").val();
	        final.push('<p><h2>Type:datepicker</h2><label>' + lbl + '</label><input type="text"' + req + 'name="' + name + '" placeholder="dd-mm-yy" class="supto_datepicker ' + cls + '"><a href="#" class="remove">remove</a></p>');
	    ...
	    $(document).on('click', '.save_textarea', function(event) {
	        ...
	        var cls = $(".class").val();
	        var placeholder = $(".placeholder").val();
	        final.push('<p><h2>Type:textarea</h2><label>' + lbl + '</label><textarea ' + req + 'name="' + name + '" placeholder="' + placeholder + '" class="' + cls + '"></textarea><a href="#" class="remove">remove</a></p>');
	    ...
	    $(document).on('click', '.save_file', function(event) {
	        ...
	        var lbl = $(".label").val();
	        var cls = $(".class").val();
	        final.push('<p><h2>Type:final</h2><label>' + lbl + '</label><input type="file" ' + req + 'name="files" class="' + cls + '"><a href="#" class="remove">remove</a></p>');
	    ...
	    $(document).on('click', '.save_tel', function(event) {
	        ...
	        var cls = $(".class").val();
	        var placeholder = $(".placeholder").val();
	        final.push('<p><h2>Type:telephone</h2><label>' + lbl + '</label><input type="text" ' + req + ' name="' + name + '" placeholder="' + placeholder + '" class="' + cls + '"><a href="#" class="remove">remove</a></p>');
	        var temp = '<p><label>' + lbl + '</label><input type="text" ' + req + ' name="' + name + '" placeholder="' + placeholder + '" class="' + cls + '"></p>';
	        $(".dummy").html("");
	        fields.push(temp);
	        putval(fields);
	    ...
	    $(document).on('click', '.save_email', function(event) {
	        ...
	        var cls = $(".class").val();
	        var placeholder = $(".placeholder").val();
	        final.push('<p><h2>Type:email</h2><label>' + lbl + '</label><input type="email"' + req + ' name="' + name + '" placeholder="' + placeholder + '" class="' + cls + '"><a href="#" class="remove">remove</a></p>');
	    ...
	    $(document).on('click', '.save_select', function(event) {
	        ...
	        final.push('<p><h2>Type:select</h2><label>' + lbl + '</label><select class="' + cls + '" name="' + name + '">' + option + '</select><a href="#" class="remove">remove</a></p>');
	    ...
	    $(document).on('click', '.save_select_email', function(event) {
	        ...
	        final.push('<p><h2>Type:select with email</h2><label>' + lbl + '</label><select class="' + cls + '" name="select_email">' + option + '</select><a href="#" class="remove">remove</a></p>');
